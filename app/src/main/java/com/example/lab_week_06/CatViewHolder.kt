...
class CatViewHolder(
    ...
    private val onClickListener: OnClickListener // DIUBAH: Parameter baru ditambahkan
    ...
    fun bindData(cat: CatModel) {
        // DITAMBAHKAN: Mendeteksi klik pada item
    ...
    // DITAMBAHKAN: Interface untuk menangani klik
